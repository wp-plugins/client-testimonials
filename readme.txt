...
Just create your Testimonials from the Testimonials menu & paste the following shortcode where you want to display this Testimonials:

`[testimonial posts_per_page="1" orderby="none" testimonial_id=""]`

Or you can paste following to add Slider Testimonials:
